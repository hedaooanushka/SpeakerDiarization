...
def parse_opts():
    ...
    parser.add_argument('--audio_backbone', default='sincdsnet', type=str, help='Currently only sincdsnet is supported')
    parser.add_argument('--audio_backbone_pretrained_path', default=None, type=str, help='Pretrained audio backbone weight')
    parser.add_argument('--annotation_train', default='./ava_activespeaker_train_augmented.csv', type=str, help='Train annotation path')
    parser.add_argument('--annotation_val', default='./ava_activespeaker_val_augmented.csv', type=str, help='Val annotation path')
    parser.add_argument('--annotation_test', default='/usr/home/kop/ASDNet/ava_activespeaker_test_augmented.csv', type=str, help='Test annotation path')
    parser.add_argument('--input_audio_dir', default='./audio', type=str, help='Input audio directory')
    parser.add_argument('--input_video_dir', default='./image', type=str, help='Input video directory')
